...
if 'xai_records' in locals() and len(xai_records) > 0:
    ...
    spark_xai = spark_xai \
    .withColumn("xgb_feature_importance", round(col("xgb_feature_importance"), 4)) \
    .withColumn("feature_value", round(col("feature_value"), 4)) \
    .withColumn("shap_value", round(col("shap_value")).cast("int"))
